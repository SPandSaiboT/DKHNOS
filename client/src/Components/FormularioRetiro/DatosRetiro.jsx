...
function DatosRetiro() {
    return (
        <form class="row g-3">
        <div class="col-md-12">
            <label for="inputDespachante" class="form-label">Nombre y Apellido de quien recibe</label>
        ...
        <div class="col-md-6">
            <label for="inputDia" class="form-label">Dia de Entrega</label>
            <input type="text" class="form-control" id="inputDia"/>
        </div>
        <div class="col-md-6">
            <label for="inputHorario" class="form-label">Horario de Entrega</label>
